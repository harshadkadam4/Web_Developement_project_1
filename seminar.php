...
<ul>
    ...
    <div class="login-box">
        ...
        echo "</table>";
        ?>
        <a href="seminar_book.html"><input type="submit" name="Book" value="Book"></a>
        <a href="seminar_cancel.html"><input type="submit" name="Login" value="Cancel Booking" id="cancel"></a>
    </div>
